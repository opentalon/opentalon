...
const file_plugin_proto_rawDesc = "" +
	"\n" +
	"\fplugin.proto\x12\x13opentalon.plugin.v1\"4\n" +
	...
	"\brequired\x18\x04 \x01(\bR\brequired2\xca\x01\n" +
	"\rPluginService\x12X\n" +
	"\aExecute\x12$.opentalon.plugin.v1.ToolCallRequest\x1a'.opentalon.plugin.v1.ToolResultResponse\x12_\n" +
	"\fCapabilities\x12&.opentalon.plugin.v1.PluginInitRequest\x1a'.opentalon.plugin.v1.PluginCapabilitiesB/Z-github.com/opentalon/opentalon/proto/pluginpbb\x06proto3"
...
var file_plugin_proto_depIdxs = []int32{
	...
	1, // 3: opentalon.plugin.v1.PluginService.Execute:input_type -> opentalon.plugin.v1.ToolCallRequest
	0, // 4: opentalon.plugin.v1.PluginService.Capabilities:input_type -> opentalon.plugin.v1.PluginInitRequest
	2, // 5: opentalon.plugin.v1.PluginService.Execute:output_type -> opentalon.plugin.v1.ToolResultResponse
	3, // 6: opentalon.plugin.v1.PluginService.Capabilities:output_type -> opentalon.plugin.v1.PluginCapabilities
